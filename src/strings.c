...
const u8 gText_RocketOpsSecureRoute[] = _("SECURE ROUTE");
const u8 gText_RocketOpsDeployAgent[] = _("DEPLOY AGENT");
const u8 gText_RocketOpsDestroyData[] = _("DESTROY DATA");
