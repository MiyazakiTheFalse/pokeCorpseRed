...
const u8 gText_Increase[] = _("INCREASE");
const u8 gText_Decrease[] = _("DECREASE");
...
const u8 gText_GiovanniMemorySaveBlocked[] = _("Memory turbulence detected.\pProgress cannot be recorded now.");
const u8 gText_GiovanniMemorySaveAvailable[] = _("Memory stabilized.\pProgress recorded.");
const u8 gText_GiovanniMemorySaveStateChanged[] = _("{STR_VAR_1}");
...
const u8 gText_YouDontHaveMoney[] = _("You don't have enough souls.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_PokedollarVar1[] = _("{STR_VAR_1} SOULS");
...
const u8 gText_StaminaHudLabel[] = _("STA ");
...
const u8 gText_RocketOpsSecureRoute[] = _("SECURE CORRIDOR");
const u8 gText_RocketOpsDeployAgent[] = _("HOLD POSITION");
const u8 gText_RocketOpsDestroyData[] = _("OPEN ROUTE");
const u8 gText_RocketOpsExtractStaff[] = _("EXTRACT STAFF");
