...
static const u8 sText_PlayerPanicked[] = _("{B_PLAYER_NAME} fell...\pSOULS scattered. One chance\nto retrieve them...\p{B_PLAYER_NAME} whited out!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteoutAgainstTrainer[] = _("{B_PLAYER_NAME} is out of\nusable POKéMON!\pPlayer lost against\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME}!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerPaidAsPrizeMoney[] = _("{B_PLAYER_NAME} fell in battle...\pSOULS scattered. Retrieve\nthem before falling again...\p{B_PLAYER_NAME} whited out!{PAUSE_UNTIL_PRESS}");
...
const u16 gCaughtMonStringIds[] =
{
    ...
    [B_MSG_TOO_STRONG_TO_FOLLOW] = STRINGID_PKMNTOOSTRONGTOFOLLOW
};
...
const u8 gText_WhatWillPlayerDo[] = _("What will {B_PLAYER_NAME}\ndo?");
...
const u8 gText_CorpseSafariZoneMenu[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW 13 14 15}WAIT{CLEAR_TO 56}BAIT\nROCK{CLEAR_TO 56}RUN");
